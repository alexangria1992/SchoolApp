   ...
   <div class="panel-body">
      <fieldset>
         ...
         <div class="pull pull-right">
            ...
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#addTeacher"
               id="addTeacherModalBtn"><i class="glyphicon glyphicon-plus-sign"></i>
            Add Teacher
            </button>
         </div>
         <br/> <br/> <br/>
...
<div class="modal fade" tabindex="-1" role="dialog" id="addTeacher">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         ...
         <form class="form-horizontal" method="post" id="createTeacherForm" action="<?php echo base_url('teacher/create')?>"
