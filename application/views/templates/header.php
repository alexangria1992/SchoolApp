  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       <li id="topNavDashboard"><a href="<?php echo base_url('dashboard') ?>"><i class="glyphicon glyphicon-dashboard"></i>
       Dashboard</a></li>
        ...
        <li class="dropdown" id="topStudentMainNav">
          ...
          <ul class="dropdown-menu">
            ...
            <li  id="addBulkStudentNav"><a href="<?php echo base_url('student?opt=blukst') ?>">Add Bulk Student</a></li>
        ...
        <li class="dropdown" id="topMarksheetMainNav">
          ...
          <ul class="dropdown-menu">
            <li  id="manageMarksheet"><a href="<?php echo base_url('marksheet?opt=mngms') ?>">Marksheet</a></li>
